...
#else
	SystemPtr system(new SystemList<boost::mpl::list<SimpleLogManager, SimpleTimerManager, OgreGraphicsManager, CEGUIManager, OISInputManager, FmodSoundManager, /*OgreNewtManager,*/ PluginsManager> >());
#endif
